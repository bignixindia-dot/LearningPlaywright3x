...
license: MIT
metadata:
  author: Prrammod Dutta | TheTestingAcademy
...
1. **Fetch the ticket.**
1. If JIRA MCP or atlassian MCP or ROVO mcp is connected the fetch the ticket via that  - https://www.atlassian.com/platform/rovo-mcp
2. If a JIRA key is given, pull it via an available JIRA MCP tool
